<div class="daftar-karyawan">
    <div class="form-card">
        <div class="panel-form">Data Panel 3</div>
        ...
        <div class="panel-form">
            <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                class="btn btn-outline-success" type="button" href="admin.php?page=add_panel_3">Tambah User</a>
        </div>
        <div class="card">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $pecah['panel3']; ?></td>
                            <td><?php echo $pecah['text3']; ?></td>
                            <td>
                                <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                                    class="btn btn-outline-info" type="button"
                                    href="admin.php?page=update_panel_3">Edit</a>
                                <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                                    class="btn btn-outline-danger" type="button"
                                    href="admin.php?page=delete_panel_3&id=<?php echo $pecah['id']; ?>">Delete</a>
                            </td>
