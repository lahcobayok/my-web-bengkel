<div class="daftar-karyawan">
    <div class="form-card">
        <div class="panel-form">Data Panel 1</div>
        ...
        <div class="panel-form">
            <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                class="btn btn-outline-success" type="button" href="admin.php?page=add_panel_1">Tambah User</a>
        </div>
        <div class="card">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $pecah['panel1']; ?></td>
                            <td><?php echo $pecah['text1']; ?></td>
                            <td>
                                <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                                    class="btn btn-outline-info" type="button"
                                    href="admin.php?page=update_panel_1">Edit</a>
                                <a style="--bs-btn-padding-y: .20rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;"
                                    class="btn btn-outline-danger" type="button"
                                    href="admin.php?page=delete_panel_1&id=<?php echo $pecah['id']; ?>">Delete</a>
                            </td>
