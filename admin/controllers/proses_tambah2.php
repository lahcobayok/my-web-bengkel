<div class="daftar-admin">
    <div class="d-flex justify-content-center">
        <div class="card">
            <div class="card-body">
                <div class="panel-form">Tambah User karyawan</div>
                ...
                if (isset($_POST['simpan'])) {
                    # code...
                    $koneksi->query("INSERT INTO daftar_karyawan(username, password, jabatan) VALUES('" . $_POST['username'] . "','" . $_POST['password'] . "','" . $_POST['jabatan'] . "')");
                    if ($koneksi) {
