        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="admin.php">Daftar admin</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="admin.php?page=update_dashboard">Ubah Dashboard</a>
                    </li>
                </ul>
    ...
    <div class="d-flex justify-content-center">
        ...
        if (isset($_GET['page'])) {
            ...
            elseif ($_GET['page'] == 'proses_keluar') {
                ...
                include 'controllers/update/update_karyawan.php';
            }
