        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="index.php?page=contact">Contacts</a></li>
                </ul>
                <a class="btn btn-primary shadow" role="button" href="index.php?page=login">Log in admin</a>
            </div>
        </div>
    </nav>
